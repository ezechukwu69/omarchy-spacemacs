...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                      ;; (package-name :location (recipe :fetcher github :repo "username/repo-name" :commit "optional-commit-hash"))
                                      (jj-mode :location (recipe :fetcher github :repo "bolivier/jj-mode.el"))
                                      persp-projectile
                                      dape
                                      )
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; in emacs 27.
   ;; (default (* 1024 1024))
   dotspacemacs-read-process-output-max (* 1024 1)
   ...
   dotspacemacs-default-font '("Aporetic Sans Mono"
                               :size 10.5
                               :weight bold
                               :width normal)
   ...
   ;; dotspacemacs-which-key-position '(posframe . bottom-right-corner)
...
before packages are loaded."
  (with-eval-after-load 'lsp-mode
    (define-key lsp-mode-map (kbd "C-c q") lsp-command-map))
  ...
  ;;   :ensure t
  ;;   :bind ("M-m p p" . projectile-persp-switch-project))
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link add-node-modules-path afternoon-theme aggressive-indent alect-themes
                ...
                clues-theme code-review color-theme-sanityinc-solarized
                color-theme-sanityinc-tomorrow column-enforce-mode
                compleseus-spacemacs-help consult consult-lsp consult-yasnippet
                cyberpunk-theme dakrone-theme dap-mode dape darkmine-theme
                darkokai-theme darktooth-theme dart-mode dart-server define-word
                devdocs diff-hl diminish dired-quick-sort disable-mouse
                django-theme doom-modeline doom-themes dotenv-mode dracula-theme
                drag-stuff dumb-jump eat ef-themes elisp-def elisp-demos
                ...
                farmhouse-themes flatland-theme flatui-theme flutter flycheck-elsa
                flycheck-package flycheck-pos-tip gandalf-theme ggtags git-link
                ...
                ibuffer-projectile impatient-mode import-js indent-guide inf-ruby
                info+ inkpot-theme inspector ir-black-theme jazz-theme
                jbeans-theme js-doc js2-mode js2-refactor kaolin-themes
                light-soap-theme link-hint livid-mode lorem-ipsum lsp-dart
                lsp-docker lsp-origami lsp-treemacs lsp-ui lush-theme macrostep
                madhat2r-theme marginalia material-theme minimal-theme minitest
                ...
                omtose-phellack-themes open-junk-file orderless org-alert
                org-cliplink org-contrib org-download org-mime org-pomodoro
                org-present org-projectile org-rich-yank org-roam org-roam-ui
                org-superstar organic-green-theme orgit-forge overseer
                page-break-lines paradox password-generator pcre2el
                persp-projectile perspective phoenix-dark-mono-theme
                phoenix-dark-pink-theme planet-theme popwin prettier-js
                professional-theme purple-haze-theme quickrun railscasts-theme
                rainbow-delimiters rake rebecca-theme restart-emacs reverse-theme
                rspec-mode rubocop rubocopfmt ruby-hash-syntax ruby-refactor
                ruby-test-mode ruby-tools seti-theme shell-pop simple-httpd
                skewer-mode smeargle smyx-theme soft-charcoal-theme
                ...
                terminal-here tern toc-org toxi-theme treemacs-icons-dired
                ...
                undo-fu-session unfill vertico vi-tilde-fringe volatile-highlights
                vterm vundo web-beautify web-mode websocket wgrep white-sand-theme
